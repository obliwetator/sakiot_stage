...
import { useCreateClipMutation, useDownloadFileMutation } from '../../app/apiSlice';
import { AudioParams } from '../../Constants';

export function ClipDialog(props: { params: Readonly<Params<AudioParams>>; startEnd: number[]; disabled: boolean }) {
	...
	return (
		<>
			...
			<Dialog open={open} onClose={handleClose}>
				<DialogContent>
					<DialogContentText>
						Enter a name for this clip. Will return an error if name is a duplicate. Leave blank for default name
					</DialogContentText>
					<TextField
						value={text}
